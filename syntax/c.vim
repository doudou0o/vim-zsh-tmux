...
" hi def link cCustomClass Function
 ...
 hi cCustomFunc  guifg=#268bd2 ctermfg=34 cterm=bold
 hi cCustomClass guifg=#00FF00 ctermfg=98 cterm=bold
 hi cCustomArrowClass guifg=#00FF00 ctermfg=87 cterm=bold
 hi cCustomDotClass guifg=#06b62c ctermfg=87 cterm=bold

syn match cCustomFunctionDefinition "\~\?\zs\h\w*\s*\ze([^)]*\()\s*\(const\)\?\){\?$"
hi cCustomFunctionDefinition guifg=#268bd2 cterm=bold ctermfg=39 "gui=bold
